...
class BetMatcher:
    ...
    @staticmethod
    def find_outcome_by_name(outcome_name: str, market_odds: Dict[str, List[Dict[str, Any]]], 
                             market_key: str = None) -> Optional[Tuple[str, Dict[str, Any]]]:
    ...
    @staticmethod
    def create_target_identifier(outcome_name: str, market_odds: Dict[str, List[Dict[str, Any]]], 
                                 market_key: str = None) -> Optional[str]:
    ...
    @staticmethod
    def find_matching_outcomes(target_identifier: str, market_odds: Dict[str, List[Dict[str, Any]]], 
                               market_key: str = None) -> List[Tuple[str, Dict[str, Any]]]:
    ...
    @staticmethod
    def find_best_odds(outcome_name: str, market_odds: Dict[str, List[Dict[str, Any]]], 
                       market_key: str = None, 
                       bookmaker_priority: Optional[List[str]] = None) -> Optional[Tuple[str, float, int]]:
        ...
        matching_outcomes = BetMatcher.find_matching_outcomes(target_identifier, market_odds, market_key)
    ...
    @staticmethod
    def count_major_books(outcome_name: str, market_odds: Dict[str, List[Dict[str, Any]]], 
    ...
    @staticmethod
    def format_all_odds(outcome_name: str, market_odds: Dict[str, List[Dict[str, Any]]], 
                        market_key: str = None) -> str:
    ...
    @staticmethod
    def count_major_books_with_both_sides(market_odds: Dict[str, List[Dict[str, Any]]], 
                                          market_key: str = None, 
                                          major_books: Optional[List[str]] = None) -> int:
        """
