...
def create_mock_request(method: str = "GET", url: str = "/", headers: Dict = None, json_data: Dict = None):
...
def assert_opportunity_format(opportunity: Dict[str, Any]):
    ...
    required_fields = [
        "id", "event", "bet_desc", "bet_type", "sport", 
        "ev_pct", "best_odds", "fair_odds", "best_source",
        "game_time", "classification"
    ]
