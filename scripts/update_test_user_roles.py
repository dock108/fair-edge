...
async def update_test_user_roles():
    ...
    url = os.getenv('SUPABASE_URL', 'https://orefwmdofxdxjjvpmmxr.supabase.co')
    service_key = os.getenv('SUPABASE_SERVICE_ROLE_KEY', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9yZWZ3bWRvZnhkeGpqdnBtbXhyIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0ODc5MTQ2NiwiZXhwIjoyMDY0MzY3NDY2fQ.vK0b55eyhq9hi8R0yvVVWU__E7UA9klGWxiOQxFAFoI')
