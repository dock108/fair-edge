...
def upgrade() -> None:
    ...
    op.add_column('profiles', sa.Column('apple_original_transaction_id', sa.String(255), nullable=True))
    op.add_column('profiles', sa.Column('apple_receipt_data', sa.Text, nullable=True))
    op.add_column('profiles', sa.Column('apple_subscription_group_id', sa.String(255), nullable=True))
    op.add_column('profiles', sa.Column('apple_purchase_date', sa.DateTime(timezone=True), nullable=True))
    op.add_column('profiles', sa.Column('apple_expires_date', sa.DateTime(timezone=True), nullable=True))
    ...
    op.create_index('idx_profiles_apple_original_transaction_id', 'profiles', ['apple_original_transaction_id'])
