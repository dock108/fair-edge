...
def upgrade():
    ...
    op.create_index('idx_device_tokens_device_token', 'device_tokens', ['device_token'], unique=False)
    op.create_index('idx_device_tokens_active', 'device_tokens', ['is_active'], unique=False)
    op.create_index('idx_device_tokens_user_active', 'device_tokens', ['user_id', 'is_active'], unique=False)
