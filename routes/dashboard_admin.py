...
async def get_dashboard_activity_stats(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Error retrieving dashboard activity statistics"
        )
...
async def cleanup_dashboard_sessions(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error cleaning up expired sessions")
...
async def test_smart_refresh_logic(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error testing smart refresh logic")
...
async def get_refresh_history(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error retrieving refresh history")
