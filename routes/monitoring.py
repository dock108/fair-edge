...
from services.persistence_monitoring import log_performance_metrics, persistence_monitor
...
async def health_check() -> Dict[str, Any]:
    ...
    try:
        ...
        if (
            not db_status.get("overall_status") == "healthy"
            or persistence_health.get("status") != "healthy"
        ):
