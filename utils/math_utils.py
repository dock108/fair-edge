...
class MathUtils:
    ...
    @staticmethod
    def calculate_ev_net(fair_probability: float, market_decimal_odds: float, fee_rate: float = 0.0) -> float:
        """
    ...
    @staticmethod
    def calculate_maker_probability(fair_probability: float, target_ev: float, fee_rate: float = 0.0) -> float:
        """
    ...
    @staticmethod
    def calculate_maker_odds(fair_probability: float, target_ev: float, fee_rate: float = 0.0) -> Dict[str, float]:
        """
