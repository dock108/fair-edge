...
from services.redis_cache import get_analytics_data, get_ev_data, get_last_update
...
def fetch_opportunities_data() -> DataFetchResult:
    ...
    try:
        ...
        if raw_data.get("status") == "success":
            ...
            return DataFetchResult(
                opportunities=opportunities, analytics=analytics, data_source="live"
            )
        else:
...
def apply_role_based_filtering(
    opportunities: List[Dict[str, Any]], user_role: str
) -> Dict[str, Any]:
    """
...
class OpportunityProcessor:
    ...
    def process(self, search: Optional[str] = None, sport: Optional[str] = None) -> Dict[str, Any]:
        """
