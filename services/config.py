...
BOOKMAKERS = {
    'pinnacle': {
        ...
        'type': 'sharp',
        'region': 'eu',
        'affiliate_url': 'https://pinnacle.com'  # Replace with actual affiliate link
    },
    'draftkings': {
        'key': 'draftkings', 
        'name': 'DraftKings',
        'type': 'us_book',
        'region': 'us',
        'affiliate_url': 'https://draftkings.com'  # Replace with actual affiliate link
    },
    'fanduel': {
        'key': 'fanduel',
        'name': 'FanDuel', 
        'type': 'us_book',
        'region': 'us',
        'affiliate_url': 'https://fanduel.com'  # Replace with actual affiliate link
    },
    'novig': {
        'key': 'novig',
        'name': 'Novig',
        'type': 'exchange',
        'region': 'us_ex',  # Exchanges use us_ex region
        'affiliate_url': 'https://novig.com'  # Replace with actual affiliate link
    },
    'prophetx': {
        'key': 'prophetx',
        'name': 'ProphetX',
        'type': 'exchange', 
        'region': 'us_ex',  # Exchanges use us_ex region
        'affiliate_url': 'https://prophetx.com'  # Replace with actual affiliate link
    }
}
...
ADDITIONAL_MARKETS = {
    'americanfootball_nfl': [
        ...
        # Combo props
        'player_pass_rush_reception_yds', 'player_pass_rush_reception_tds', 'player_rush_reception_yds', 'player_rush_reception_tds',
    ...
    'basketball_nba': [
        # Core scoring props
        'player_points', 'player_points_q1', 'player_field_goals', 'player_threes', 'player_frees_made',
        # Core stat props
        'player_rebounds', 'player_assists', 'player_steals', 'player_blocks', 'player_turnovers',
        # Combo props
        ...
        # Period markets
        'h2h_h1', 'h2h_h2', 'spreads_h1', 'spreads_h2', 'totals_h1', 'totals_h2',
        'h2h_q1', 'h2h_q4', 'spreads_q1', 'spreads_q4', 'totals_q1', 'totals_q4'
    ],
    'basketball_ncaab': [
        # Same as NBA but subset for college
    ...
    'baseball_mlb': [
        ...
        'batter_singles', 'batter_doubles', 'batter_triples', 'batter_walks', 'batter_strikeouts', 
        'batter_stolen_bases', 'batter_hits_runs_rbis', 'batter_first_home_run',
        # Core pitcher props
