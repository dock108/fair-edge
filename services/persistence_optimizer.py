...
class PersistenceOptimizer:
    ...
    def get_optimal_batch_size(self) -> int:
        ...
        try:
            ...
            logger.info(f"Optimal batch size calculated: {base_size} (avg_duration={avg_duration:.0f}ms, success_rate={success_rate:.2f})")
            return base_size
    ...
    def optimize_if_needed(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.info(f"Persistence optimization completed: batch_size={optimal_batch_size}, recommendations={len(recommendations.get('recommendations', []))}")
